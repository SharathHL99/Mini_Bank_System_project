...
public class ReportingServiceImpl implements ReportingService {
    ...
    public List<StatementEntryDTO> getStatement(Long accountId, LocalDate from, LocalDate to) {
        ...
        List<StatementEntryDTO> statementList = new ArrayList<>();
    ...
    public BalanceSummaryDTO getBalanceSummary(Long accountId, LocalDate from, LocalDate to) {
        ...
        BigDecimal totalDeposits = transactionRepository.sumByType(
                accountId, TransactionType.DEPOSIT, start, end);

        BigDecimal totalWithdrawals = transactionRepository.sumByType(
